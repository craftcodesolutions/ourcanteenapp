    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: cardBg }]}>
      ...
      >
        ...
        >
          <TouchableOpacity
            activeOpacity={1}
            style={{ backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 24, alignItems: 'center' }}
            ...
            {selectedItem && (
              <>
                ...
                <View style={{ width: '100%', alignItems: 'flex-start', marginTop: 16 }}>
                  ...
                  <ThemedText style={{ fontSize: 14, color: '#888', marginBottom: 2, textAlign: 'left' }}>Restaurant: {selectedItem.restaurantName}</ThemedText>
